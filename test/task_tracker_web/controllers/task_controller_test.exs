defmodule TaskTrackerWeb.TaskControllerTest do
  ...
  @create_attrs %{assigned: "some assigned", completed: true, desc: "some desc", time: 42, title: "some title"}
  @update_attrs %{assigned: "some updated assigned", completed: false, desc: "some updated desc", time: 43, title: "some updated title"}
  @invalid_attrs %{assigned: nil, completed: nil, desc: nil, time: nil, title: nil}
